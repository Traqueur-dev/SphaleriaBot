...
public class StaffAddCommand extends ICommand {

    @Command(name = {"staff.add"}, permittedRoles = {"537682405893341185", "537682450407620637"},
            permittedUsers = "285375027480756224", description = "Permet d'ajouter un role comme staff")
    public void onCommand(CommandArgs args) {
        ...
        boolean isAdd = manager.addRoleID(role.getIdLong());
        EmbedBuilder builder = null;
        if (isAdd) {
            builder = args.getSuccess();
            builder.addField("Succés:", args.getSender() + " vient d'ajouter le role " + role.getName()
